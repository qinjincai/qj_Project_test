  ...
  <div class="detail">
    ...
    <section class="con">
      ...
      <div class="conPoin">
        ...
        <span v-show="categoryView.category3Id">{{ categoryView.category2Name }}</span>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{active:_val.isChecked == 1}"
                  v-for="(_val) in spuSaleAttr.spuSaleAttrValueList" :key="_val.id"
                  @click="changeActive(_val, spuSaleAttr.spuSaleAttrValueList)">{{ _val.saleAttrValueName }}
                </dd>
