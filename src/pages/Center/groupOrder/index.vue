    ...
    <div class="order-content">
      ...
      <div class="chosetype">
        <table>
          <thead>
          <tr>
            <th width="29%">是团购订单商品</th>
            <th width="31%">是团购订单订单详情</th>
            <th width="13%">是团购订单收货人</th>
            <th>是团购订单金额</th>
            <th>是团购订单状态</th>
            <th>是团购订单操作</th>
          </tr>
      ...
      <div class="orders">
        ...
        <table class="order-item">
          ...
          <tr>
            <th colspan="5">
                      <span class="ordertitle">是团购订单2017-02-11 11:59　订单编号：7867473872181848 <span
          ...
          <tr>
            <td width="60%">
              <div class="typographic">
                ...
                <a href="#" class="block-text">是团购订单包邮 正品玛姬儿压缩面膜无纺布纸膜100粒 送泡瓶面膜刷喷瓶 新款</a>
                <span>x1</span>
                <a href="#" class="service">是团购订单售后申请</a>
              </div>
            </td>
            <td rowspan="2" width="8%" class="center">是团购订单小丽</td>
            <td rowspan="2" width="13%" class="center">
              <ul class="unstyled">
                <li>是团购订单总金额¥138.00</li>
                <li>是团购订单在线支付</li>
